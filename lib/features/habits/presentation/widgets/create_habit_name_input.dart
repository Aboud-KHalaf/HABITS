      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: AppTypography.bodyLg.copyWith(color: AppColors.onSurfaceVariant),
            enabledBorder: const UnderlineInputBorder(
              borderSide: BorderSide(color: AppColors.onSurfaceVariant, width: 2),
            ),
